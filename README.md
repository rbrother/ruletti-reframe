...
* [`src/ruletti_reframe/`](src/ruletti_reframe/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/ruletti_reframe/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `ruletti-reframe` project root directory
